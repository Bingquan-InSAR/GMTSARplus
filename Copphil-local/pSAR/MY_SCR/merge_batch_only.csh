...
#
  ...
  foreach line (`awk '{print $0}' $input_file`)
    ...
    if (! -d $dir_name) then
      #
      echo " ++++++++++++++++++++++++++++++"
      echo " Progress: Working on $dir_name"
      echo " ++++++++++++++++++++++++++++++"
      #
      mkdir $dir_name
      cd $dir_name
      ...
      foreach f_name (`awk '{print $0}' < tmp`)
        ...
        echo $f1 $f2
        echo "   **** making supermaster.PRM from $mm"
      ...
      rm tmp
      #
      echo " merge_wrap_geocode_tops.csh tmp.filelist $2" 
      merge_wrap_geocode_tops.csh tmp.filelist $2
      #
